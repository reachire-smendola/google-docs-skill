...
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb create
```
...
```bash
~/.agents/skills/google-docs/scripts/docs_manager.rb read 1abc-xyz-document-123
```
...
```bash
~/.agents/skills/google-docs/scripts/docs_manager.rb structure 1abc-xyz-document-123
```
...
echo '{
  ...
  "index": 1
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb insert
```
...
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb append
```
...
echo '{
  ...
  "replace": "Q4 2024",
  "match_case": false
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb replace
```
...
echo '{
  ...
  "end_index": 22,
  "bold": true
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb format
```
...
echo '{
  "document_id": "1abc-xyz-document-123",
  "index": 500
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb page-break
```
...
echo '{
  ...
  "start_index": 1000,
  "end_index": 1500
}' | ~/.agents/skills/google-docs/scripts/docs_manager.rb delete
```
...
~/.agents/skills/google-docs/scripts/docs_manager.rb structure new_doc_abc
...
~/.agents/skills/google-docs/scripts/docs_manager.rb read proposal_doc_123 > current_state.json
...
create_from_template() {
  ...
  }' | ~/.agents/skills/google-docs/scripts/docs_manager.rb create | jq -r '.document_id')
...
~/.agents/skills/google-drive/scripts/drive_manager.rb --operation move \
  --file-id "$doc_id" \
  --parent-id "team_folder_id_xyz"

# Step 5: Share with team
~/.agents/skills/google-drive/scripts/drive_manager.rb --operation share \
  --file-id "$doc_id" \
  --email team@company.com \
  --role writer

# Step 6: Generate PDF for archive
~/.agents/skills/google-drive/scripts/drive_manager.rb --operation export \
  --file-id "$doc_id" \
...
~/.agents/skills/google-docs/scripts/docs_manager.rb read doc_abc_123

# Step 2: Get structure for reference points
~/.agents/skills/google-docs/scripts/docs_manager.rb structure doc_abc_123
...
~/.agents/skills/google-docs/scripts/docs_manager.rb read doc_abc_123 > backup.json
...
~/.agents/skills/google-docs/scripts/docs_manager.rb read doc_abc
# ... format operation ...
~/.agents/skills/google-docs/scripts/docs_manager.rb read doc_abc
...
~/.agents/skills/google-docs/scripts/docs_manager.rb read doc_abc > state.json
~/.agents/skills/google-docs/scripts/docs_manager.rb structure doc_abc > structure.json
...
~/.agents/skills/google-docs/scripts/docs_manager.rb structure doc_abc
